...
import { useFinanceHome } from "@/hooks/useFinanceDashboard";
...
export default function FinanceHome() {
  const { data: home, isLoading: loading } = useFinanceHome();

  if (loading) return <LoadingState rows={4} />;

  return (
    <div className="space-y-6" data-testid="finance-home-page">
      <div className="glass-card p-6" data-testid="finance-welcome">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4" data-testid="finance-kpi-strip">
      ...
      {/* Approval Widget */}
      <ApprovalWidget approvalCenterPath="/finance/approvals" />

      <div data-testid="finance-quick-actions">
