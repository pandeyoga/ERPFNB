/** Vendor Performance Report — Excel export dengan metrics & bar chart */
import { useState, useEffect } from "react";
import { Download, Award, Store } from "lucide-react";
...
export default function VendorPerformanceReport() {
  ...
  async function downloadExcel() {
    ...
    try {
      ...
      const response = await api.get(`/reports/procurement/vendor-performance.xlsx?${params.toString()}`, {
        responseType: "blob",
      });
      ...
      a.href = url;
      a.download = `vendor_performance_${dateFrom}_${dateTo}.xlsx`;
    ...
    <div className="space-y-4" data-testid="vendor-performance-report-page">
      <Card className="p-5">
        <div className="flex items-center gap-3 mb-3">
          ...
          <div>
            <h1 className="text-xl font-semibold" data-testid="vendor-performance-title">Vendor Performance Report</h1>
            <p className="text-xs text-muted-foreground">Vendor scorecard: PO count, fulfillment rate, total purchase value + chart</p>
          </div>
        </div>
      </Card>
      ...
      <Card className="p-5">
        ...
        <div className="grid grid-cols-2 gap-3 mb-4">
          <div>
            ...
            <Input
              ...
              className="mt-1 h-9"
              data-testid="vendor-perf-date-from"
            />
          </div>
          <div>
            ...
            <Input
              ...
              className="mt-1 h-9"
              data-testid="vendor-perf-date-to"
            />
          </div>
        </div>
        ...
        <Button
          ...
          data-testid="vendor-perf-download-btn"
        >
