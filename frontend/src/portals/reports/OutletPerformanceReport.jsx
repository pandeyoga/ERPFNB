/** Outlet Performance Report — Excel export dengan bar chart */
import { useState, useEffect } from "react";
import { Download, TrendingUp, Store } from "lucide-react";
...
export default function OutletPerformanceReport() {
  ...
  async function downloadExcel() {
    ...
    try {
      ...
      const response = await api.get(`/reports/outlet/performance.xlsx?${params.toString()}`, {
        responseType: "blob",
      });
      ...
      a.href = url;
      a.download = `outlet_performance_${dateFrom}_${dateTo}.xlsx`;
  ...
  return (
    <div className="space-y-4" data-testid="outlet-performance-report-page">
      {/* Header */}
      <Card className="p-5">
        <div className="flex items-center gap-3 mb-3">
          ...
          <div>
            <h1 className="text-xl font-semibold" data-testid="outlet-performance-title">Outlet Performance Report</h1>
            <p className="text-xs text-muted-foreground">Performa outlet dengan total sales, avg daily, dan bar chart comparison</p>
          </div>
        </div>
      </Card>
      ...
      <Card className="p-5">
        ...
        <div className="grid grid-cols-2 gap-3 mb-4">
          <div>
            ...
            <Input
              ...
              className="mt-1 h-9"
              data-testid="outlet-perf-date-from"
            />
          </div>
          <div>
            ...
            <Input
              ...
              className="mt-1 h-9"
              data-testid="outlet-perf-date-to"
            />
          </div>
        </div>
        ...
        <Button
          ...
          data-testid="outlet-perf-download-btn"
        >
