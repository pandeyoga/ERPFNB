"""Seed FnB Group demo data for FnB Group.

Creates:
- 1 Group (FnB Group)
- 5 Brands (The Coffeeshop, The Restaurant, The Bistro, The Lounge, The Bakery) — 1 outlet each
...
- 1 Super Admin user (admin@fnbgroup.id / Demo@2026)
...
async def seed():
    ...
    # 1. Group
    print("Creating Group: FnB Group…")
    group = doc({
        "name": "FnB Group", "legal_name": "PT FnB Group Indonesia",
    ...
    brand_outlets = [
        ("CFS", "The Coffeeshop",      "#5B5FE3"),
        ("RST", "The Restaurant",   "#F59E0B"),
        ("BST", "The Bistro",     "#10B981"),
        ("LNG", "The Lounge", "#EF4444"),
        ("BKY", "The Bakery",     "#D4A574"),
    ]
    ...
    series = [
        ...
        ("JE",  "JE",  5, "JE-{YY}{MM}-{0000}"),   # Manual journal entries
        ("JER", "JER", 5, "JER-{YY}{MM}-{0000}"),  # Manual journal reversals
    ...
    emp_idx = 1
    for outlet_code in ("CFS", "RST", "BST", "LNG", "BKY"):
    ...
    for code, name in [("CFS", "The Coffeeshop"), ("RST", "The Restaurant"),
                        ("BST", "The Bistro"), ("LNG", "The Lounge"),
                        ("BKY", "The Bakery")]:
        await db.users.insert_one(doc({
            "email": f"{code.lower()}.manager@fnbgroup.id",
            "password_hash": hash_password("Demo@2026"),
    ...
    print()
    print("CREDENTIALS (all password: Demo@2026):")
    print("  admin@fnbgroup.id          — Super Admin (full access)")
    print("  executive@fnbgroup.id      — Executive / Owner")
    print("  finance@fnbgroup.id        — Finance Manager")
    print("  procurement@fnbgroup.id    — Procurement Manager")
    print("  cfs.manager@fnbgroup.id    — The Coffeeshop Outlet Manager")
    print("  rst.manager@fnbgroup.id    — The Restaurant Outlet Manager")
    print("  bst.manager@fnbgroup.id    — The Bistro Outlet Manager")
    print("  lng.manager@fnbgroup.id    — The Lounge Outlet Manager")
    print("  bky.manager@fnbgroup.id    — The Bakery Outlet Manager")
    print()
    print("Group: FnB Group | Brands: 5 | Outlets: 5")
